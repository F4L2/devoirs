...
miic_res2 = miic_res
save.image("/home/alex/Documents/RESYS/projet/miic_graphe2.Rdata")


miic_res = miic(data, nThreads=nbCores) 
miic_res3 = miic_res
save.image("/home/alex/Documents/RESYS/projet/miic_graphe3.Rdata")

miic_res = miic(data, nThreads=nbCores) 
miic_res4 = miic_res
save.image("/home/alex/Documents/RESYS/projet/miic_graphe4.Rdata")
...
dev.copy(png,filename="/home/alex/Documents/RESYS/projet/plots/miic2.png")
dev.off ()
...
KMethods = c("sqrt", "all")
genie3_weights = GENIE3(t(data), treeMethod= "RF", K="all", nTrees=1000 , verbose=F, nCores = nbCores)
...
# ==> close to barbasi network model
