...
# decoder l'image � partir du temps du 1er PA (remplacer zeros par les valeurs decodees)
# indice: pour extraire les temps des PA du neurone i, utiliser la commande suivante :
# np.where(v[i,:]>theta)[0]*dt
image_decode = np.zeros(M)
...
#pixel blanc temps court
#pixel noir temps long