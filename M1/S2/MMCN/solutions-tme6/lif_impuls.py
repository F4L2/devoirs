...
# Stimulation par un des PA entrant

i_amp = 0.1                 # microA, amplitude de courant inject� par un PA
pa = np.zeros(N)            # le tableau de temps des PA entrants

t_pa = np.arange(100, 150, 3)      # le temps d'un PA entrant

pa[ map(int, t_pa/dt) ] = 1 # le PA entrant

# Excitabilit�

tau_m = 100.     # ms, Constante de temps membranaire
